...
Note:
- Clinically: 7 harm domains.
- NHS Resolution: each domain contains multiple harm themes
- Your model: 12 harm themes (correct)
- Do NOT collapse to 7 labels for ML
- Use 7 domains only for hierarchy or explainability
